...
static uint32_t colors[][3] = {
    /*               fg          bg          border    */
    [SchemeNorm] = {0xbbbbbbff, 0x222222ff, 0},
    [SchemeSel] = {0xeeeeeeff, 0x005577ff, 0},
    [SchemeUrg] = {0, 0, 0},
};
...
static const char *const autostart[] = {
    "sh", "-c", "wlr-randr --output eDP-1 --scale 1.25", NULL, "swww-daemon",
    NULL, NULL /* terminate */
};
...
static const Key keys[] = {
    ...
    {0, XKB_KEY_XF86AudioLowerVolume, spawn,
     SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -1%")},
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn,
     SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +1%")},

    /* { MODKEY,                    XKB_KEY_space,      setlayout,      {0} },
    { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_space,      togglefloating, {0} },
    { MODKEY,                    XKB_KEY_f,          setlayout,      {.v =
    &layouts[1]} }, */
