...
static const Key keys[] = {
    ...
    {MODKEY, XKB_KEY_s, spawn, SHCMD("grimblast copy area")},
    {MODKEY, XKB_KEY_i, spawn, SHCMD("/home/shrey/scripts/info.sh")},

    {0, XKB_KEY_XF86MonBrightnessUp, spawn,
     SHCMD("/home/shrey/scripts/brightness.sh +")},
    ...
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn,
     SHCMD("/home/shrey/scripts/volume.sh +")},
    {0, XKB_KEY_XF86AudioLowerVolume, spawn,
     SHCMD("/home/shrey/scripts/volume.sh -")},
    {0, XKB_KEY_XF86AudioMute, spawn,
     SHCMD("/home/shrey/scripts/toggle_mute.sh")},
